...
const icons = {
  ...
  moon: (c = WHITE) => <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke={c} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M21 12.79A9 9 0 1111.21 3 7 7 0 0021 12.79z"/></svg>,
...
const seekerFeatures = [
  ...
  { icon: 'moon', title: 'Sleep Tracking', desc: 'Auto-sync sleep data from Apple Health and Google Health Connect. See last night\'s duration, bedtime, wake time, and quality score. Track sleep trends and correlate with workout performance.', highlights: ['Auto-sync from device', 'Sleep quality score', 'Workout correlation'] },
