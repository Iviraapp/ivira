...
const DEMO_ADS = [
  { id: 1, brand: 'MuscleBlaze', headline: 'Fuel Your Gains', sub: 'Whey Protein starting at ₹1,499', color: '#10B981' },
...
function MilestoneOverlay({ milestone, theme }) {
  ...
  const configs = {
    ...
    major: { headline: 'CHAMPION', sub: `${milestone.count}th Workout`, color: '#10B981' },
    streak: { headline: 'ON FIRE', sub: `${milestone.count}-Day Streak`, color: '#FF6B35' },
    birthday: { headline: 'HAPPY BIRTHDAY', sub: 'Your special day workout', color: '#10B981' },
  }
...
function FlashSaleBanner({ sale }) {
  ...
  return (
    <div style={{
      ...
      <div style={{ fontSize: 11, fontWeight: 700, color: '#10B981', letterSpacing: '2px', textTransform: 'uppercase', marginBottom: 4, fontFamily: FONT }}>
        LIMITED OFFER
      </div>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            border: `3px solid ${isSuccess ? '#10B981' : theme.red}`,
            boxShadow: isSuccess ? '0 0 40px rgba(16,185,129,0.4)' : undefined,
            display: 'flex', alignItems: 'center', justifyContent: 'center',
            margin: '0 auto 24px',
          ...
          {isSuccess && streakCount > 0 && (
            <div style={{
              fontSize: 13, color: '#10B981', fontFamily: FONT_M,
