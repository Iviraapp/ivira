          ...
          {timelineNodes.map((node, i) => (
            <div key={i} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', zIndex: 2, flex: 1 }}>
              <div style={{
                ...
                height: 24,
                borderRadius: '50%',
                background: node.active ? '#10B981' : '#1F1F1F',
                border: node.active ? '2px solid #10B981' : '2px solid #333',
                display: 'flex',
                alignItems: 'center',
              ...
              {i === 2 && (
                <span style={{ fontSize: 11, color: '#10B981', fontWeight: 600, marginTop: 4 }}>
                  {formatDate(d.next_payout_date)}
                </span>
              )}
            </div>
        ...
        <div style={card}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            ...
            <div style={{
              ...
              height: 200,
              borderRadius: '50%',
              background: `conic-gradient(#10B981 0deg ${subscriptionAngle}deg, #22C55E ${subscriptionAngle}deg 360deg)`,
              position: 'relative',
              marginBottom: 24,
            }}>
              {/* Inner hole */}
                ...
                {monthly.map((row, i) => {
                  ...
                  return (
                    <tr key={i} style={{ borderBottom: '1px solid #1F1F1F' }}>
                      ...
                      <td style={{ padding: '12px', fontSize: 14, color: '#10B981', fontWeight: 500, fontFamily: font }}>
