      ...
      <nav style={{
        ...
        <div style={{
          ...
          <Link to="/" style={{
            ...
            color: t.text, textDecoration: 'none', letterSpacing: '0.3em',
          }}>
            I V I R A
          </Link>
        ...
        <div style={{ maxWidth: 1120, margin: '0 auto', padding: '80px 24px' }}>
          ...
          <div style={{
            ...
            {existingMemberBenefits.map((b, i) => (
              ...
              >
                <div style={{ position: 'absolute', top: 0, left: 0, right: 0, height: 3, background: ['#3B82F6', '#EF4444', '#22C55E', '#F59E0B'][i] }} />
