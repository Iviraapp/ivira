...
export default function Onboarding() {
  ...
  const brandGlow = `rgba(124,58,237,0.35)`
          ...
          {[
            ...
            <label
              ...
              style={{
                ...
                background: paymentGateway === gw.value ? (isDark ? 'rgba(124,58,237,0.1)' : 'rgba(124,58,237,0.05)') : 'transparent',
  ...
  return (
    <div style={{
      ...
      <style>{`
        @keyframes glowPulse {
          0%, 100% { box-shadow: 0 0 20px ${brandGlow}, 0 0 40px rgba(124,58,237,0.15); }
          50% { box-shadow: 0 0 30px ${brandGlow}, 0 0 60px rgba(124,58,237,0.25); }
        }
        @keyframes waPulse {
      ...
      {showWhatsApp && (
        <a
          href="https://wa.me/919876543210?text=Hi, I need help setting up my gym on IVIRA"
          target="_blank"
