...
function LeaderboardTab({ rankedStaff, theme, sp }) {
  ...
  const getRankIcon = (rank) => {
    if (rank === 1) return <Trophy size={18} color="#7C3AED" />
          ...
          <div key={s.id} style={{
            ...
            <div style={{
              ...
              <span style={{
                ...
                color: i === 0 ? '#7C3AED' : theme.textTer,
              }}>#{i + 1}</span>
            </div>
            {/* Avatar + Info */}
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center' }}>
              <Avatar name={s.name} size={56} style={{
                border: i === 0 ? '2px solid #7C3AED' : `1px solid ${theme.border}`,
                marginBottom: sp(12),
              }} />
              <div style={{
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    <span style={{ fontSize: 13, fontWeight: 700, color: '#7C3AED', fontFamily: FONT_M }}>
                      {Math.min(100, Math.round((s.metrics.bookings_count / 40) * 100))}
                    </span>
                  </div>
                  <div style={{ height: 4, borderRadius: 2, background: 'rgba(124,58,237,0.15)' }}>
                    <div style={{
    ...
    <div>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', gap: sp(4), marginBottom: sp(16), borderRadius: 10, overflow: 'hidden', height: 40 }}>
          <div style={{
            width: '85%', background: 'linear-gradient(135deg, #7C3AED, #9F67FF)',
            display: 'flex', alignItems: 'center', justifyContent: 'center',
        ...
        <div style={{ display: 'flex', gap: sp(16), flexWrap: 'wrap' }}>
          {[
            { label: 'Trainer Share', pct: '85%', color: '#7C3AED' },
          ...
          return (
            <div key={s.id} style={{
              ...
              <div style={{
                ...
                <div style={{ width: '85%', background: 'linear-gradient(135deg, #7C3AED, #9F67FF)' }} />
            ...
            {allStaff.map((s, i) => {
              ...
              return (
                <tr key={s.id} style={{
                  ...
                  <td style={{ padding: `${sp(12)}px ${sp(16)}px`, fontFamily: FONT_M, fontSize: 14, color: '#7C3AED', fontWeight: 600 }}>
