...
const TYPE_BADGES = {
  trainer: { label: 'Trainer', bg: 'rgba(16,185,129,0.12)', color: '#10B981' },
...
function TrainerAvatar({ name, photo_url, size = 56 }) {
  ...
  return (
    <div style={{
      width: size, height: size, borderRadius: '50%',
      background: 'linear-gradient(135deg, #10B981, #5B21B6)',
...
function SpecChip({ label, removable, onRemove }) {
  return (
    <span style={{
      ...
      background: 'rgba(16,185,129,0.1)', color: '#3B6FD4',
  ...
  return (
    <div style={{ fontFamily: FONT }}>
      ...
      <div style={{
        ...
        {[
          { label: 'Total Trainers', value: totalTrainers, icon: User, color: '#10B981' },
        ...
        <div style={{
          ...
          {[1, 2, 3].map(s => (
            <div key={s} style={{
              ...
              background: s <= step ? '#10B981' : '#1F1F1F',
                  ...
                  return (
                    <button
                      ...
                      style={{
                        ...
                        border: selected ? '1px solid #10B981' : '1px solid #1F1F1F',
