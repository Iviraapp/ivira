              ...
              return (
                <button
                  ...
                  onClick={() => {
                    ...
                    window.open(`https://wa.me/919876543210?text=Hi%20Sunil,%20this%20is%20${ownerName}%20from%20${gymName}.%20I%20need%20priority%20assistance%20with%20[Subject]`, '_blank')
                  }}
                  style={{
                ...
                >
                  <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="#7C3AED" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" style={{ flexShrink: 0 }}>
              ...
              return (
                <button
                  ...
                  onClick={() => {
                    ...
                    window.open(`https://wa.me/919876543210?text=Hi%20Sunil,%20this%20is%20${ownerName}%20from%20${gymName}.%20I%20need%20help%20with%20[Subject]`, '_blank')
                  }}
                  style={{
                    display: 'flex', alignItems: 'center', gap: 10, width: '100%',
                    padding: `${sp(9)}px ${sp(12)}px`, borderRadius: 8,
