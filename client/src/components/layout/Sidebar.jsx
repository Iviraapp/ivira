...
import {
  ...
  Settings, LogOut, Dumbbell, UserCog, X, MapPin, ShieldCheck, ShoppingBag, Award, TrendingUp, Activity, Lock, Heart, Brain,
} from 'lucide-react'
...
const navGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { path: '/dashboard/finance', label: 'Finance AI', icon: Brain, featureSlug: 'analytics' },
    ],
  },
  {
    label: 'HEALTH',
