...
const MOCK_SCAN_RESULTS = [
  {
    items: [
      { name: 'Masala Dosa', calories: 330, protein: 7, carbs: 50, fat: 12, confidence: 0.92 },
      { name: 'Coconut Chutney', calories: 60, protein: 1, carbs: 6, fat: 4, confidence: 0.85 },
      { name: 'Sambar (1 bowl)', calories: 120, protein: 5, carbs: 16, fat: 3, confidence: 0.88 },
    ],
  },
  {
    items: [
      { name: 'Chicken Biryani', calories: 520, protein: 28, carbs: 62, fat: 16, confidence: 0.94 },
      { name: 'Raita', calories: 45, protein: 2, carbs: 3, fat: 2, confidence: 0.80 },
    ],
  },
  {
    items: [
      { name: 'Paneer Butter Masala', calories: 340, protein: 14, carbs: 12, fat: 26, confidence: 0.91 },
      { name: 'Butter Naan (2 pcs)', calories: 310, protein: 8, carbs: 42, fat: 12, confidence: 0.87 },
      { name: 'Dal Tadka', calories: 180, protein: 10, carbs: 22, fat: 6, confidence: 0.83 },
    ],
  },
  {
    items: [
      { name: 'Idli (4 pcs)', calories: 200, protein: 6, carbs: 40, fat: 1, confidence: 0.95 },
      { name: 'Sambar', calories: 120, protein: 5, carbs: 16, fat: 3, confidence: 0.86 },
      { name: 'Podi (gunpowder)', calories: 40, protein: 1, carbs: 3, fat: 3, confidence: 0.72 },
    ],
  },
  {
    items: [
      { name: 'Egg Bhurji', calories: 220, protein: 16, carbs: 4, fat: 16, confidence: 0.90 },
      { name: 'Whole Wheat Toast (2)', calories: 160, protein: 6, carbs: 28, fat: 2, confidence: 0.88 },
    ],
  },
]
...
const MOCK_HISTORY = [
  {
    id: 'h1',
    scanned_at: '2026-03-22T08:15:00Z',
    image_uri: null,
    items: [
      { name: 'Poha with Peanuts', calories: 250, protein: 6, carbs: 42, fat: 6 },
      { name: 'Chai (1 cup)', calories: 80, protein: 2, carbs: 12, fat: 2 },
    ],
    logged: true,
    meal_type: 'breakfast',
  },
  {
    id: 'h2',
    scanned_at: '2026-03-21T13:30:00Z',
    image_uri: null,
    items: [
      { name: 'Chicken Curry + Rice', calories: 620, protein: 35, carbs: 68, fat: 18 },
    ],
    logged: true,
    meal_type: 'lunch',
  },
  {
    id: 'h3',
    scanned_at: '2026-03-21T17:45:00Z',
    image_uri: null,
    items: [
      { name: 'Whey Protein Shake', calories: 180, protein: 24, carbs: 12, fat: 4 },
      { name: 'Banana', calories: 100, protein: 1, carbs: 26, fat: 0 },
    ],
    logged: true,
    meal_type: 'snack',
  },
  {
    id: 'h4',
    scanned_at: '2026-03-20T20:00:00Z',
    image_uri: null,
    items: [
      { name: 'Roti (3) + Palak Paneer', calories: 450, protein: 20, carbs: 48, fat: 18 },
    ],
    logged: false,
    meal_type: 'dinner',
  },
