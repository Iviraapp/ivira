...
} catch (err) { if (__DEV__) console.warn('[ActivityDash] Pedometer load:', err?.message) }
...
try {
  ...
  Circle = svg.Circle
} catch (err) { if (__DEV__) console.warn('[ActivityDash] SVG load:', err?.message) }
...
export default function ActivityDashboardScreen({ navigation }) {
  ...
  useEffect(() => {
    ...
    }).catch(err => { if (__DEV__) console.warn('[ActivityDash]', err?.message) })
  }, [])
  ...
  useEffect(() => {
    ...
    async function init() {
      ...
      if (Pedometer) {
        ...
        } catch (err) { if (__DEV__) console.warn('[ActivityDash] pedometer check:', err?.message) }
      }
  ...
  async function loadTodaySteps() {
    ...
    } catch (err) { if (__DEV__) console.warn('[ActivityDash] loadTodaySteps:', err?.message) }
  }
  ...
  async function loadWeeklySteps() {
    ...
    try {
      ...
      for (let i = 0; i <= todayIndex; i++) {
        ...
        } catch (err) { if (__DEV__) console.warn('[ActivityDash] weekly step read:', err?.message) }
      }

      setWeeklySteps(weekly)
    } catch (err) { if (__DEV__) console.warn('[ActivityDash] loadWeeklySteps:', err?.message) }
  }
  ...
  function subscribeToSteps() {
    ...
    } catch (err) { if (__DEV__) console.warn('[ActivityDash] subscribeToSteps:', err?.message) }
  }
  ...
  async function loadActivityData() {
    ...
    try {
      ...
      } catch (err) { if (__DEV__) console.warn('[ActivityDash] loadCheckins:', err?.message) }
      ...
      } catch (err) { if (__DEV__) console.warn('[ActivityDash] loadWorkouts:', err?.message) }
    } catch (err) { if (__DEV__) console.warn('[ActivityDash] loadActivityData:', err?.message) }
  }
        ...
        { text: 'Cancel', style: 'cancel' },
        {
          ...
          onPress: (value) => {
            ...
            if (!isNaN(parsed) && parsed > 0) {
              setStepGoal(parsed)
              setItem('ivira_step_goal', String(parsed)).catch(err => { if (__DEV__) console.warn('[ActivityDash]', err?.message) })
            }
          },
        },
      ],
